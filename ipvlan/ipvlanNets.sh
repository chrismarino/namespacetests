...
ip link add link ipvl0 ns0 type ipvlan mode $MODE
ip link add link ipvl0 ns1 type ipvlan mode $MODE
ip link add link ipvl0 ns2 type ipvlan mode $MODE
ip link add link ipvl0 ns3 type ipvlan mode $MODE
